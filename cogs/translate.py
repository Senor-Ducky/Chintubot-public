...
languages = {'Afrikaans': 'af', 'Albanian': 'sq', 'Amharic': 'am', 'Arabic': 'ar', 'Armenian': 'hy',
             ...
             'Estonian': 'et', 'Finnish': 'fi', 'French': 'fr', 'Frisian': 'fy', 'Galician':
                 'gl', 'Georgian': 'ka', 'German': 'de', 'Greek': 'el', 'Gujarati': 'gu', 'Haitian': 'ht',
             ...
             'Marathi': 'mr', 'Mongolian': 'mn', 'Myanmar': 'my', 'Nepali': 'ne', 'Norwegian': 'no', 'Nyanja': 'ny',
             'Pashto': 'ps', 'Persian': 'fa', 'Polish': 'pl', 'Portuguese': 'pt', 'Punjabi': 'pa', 'Romanian': 'ro',
             'Russian': 'ru', 'Samoan': 'sm', 'Scots': 'gd', 'Serbian': 'sr', 'Sesotho': 'st', 'Shona': 'sn',
             'Sindhi': 'sd', 'Sinhala': 'si', 'Slovak': 'sk', 'Slovenian': 'sl', 'Somali': 'so', 'Spanish': 'es',
             'Sundanese': 'su', 'Swahili': 'sw', 'Swedish': 'sv', 'Tagalog': 'tl', 'Tajik': 'tg', 'Tamil': 'ta',
...
class Translate(commands.Cog):
    ...
    async def translate(self, ctx, to, *, word):
        try:
            ...
            em.add_field(name="Translated Text",
                         value=json.loads(response.text)['data']['translations'][0]['translatedText'])
